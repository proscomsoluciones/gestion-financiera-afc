...
export default function Edit({ club }: { club: Club }) {
    ...
    const [crestPreview, setCrestPreview] = useState<string | null>(club.crest_url || null);
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm font-medium text-slate-500">
                            Actualizar la información institucional y directiva
                        </p>
                    </div>
                            ...
                            <div className="mt-8 flex items-center justify-between border-t border-slate-100 pt-5">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    {activeTab !== 'extra' ? (
                                        ...
                                        >
                                            {processing && <Spinner />}
                                            {processing ? 'Actualizando...' : 'Actualizar Club'}
                                        </button>
                                    )}
                                </div>
                            </div>
